...
![Static Badge](https://img.shields.io/badge/dependencies-none-brightgreen)
...
Before working with replicate weights statistics we need to be sure to create the replicate weights (if they are not provided within the data). For an example on how to create them
see `vignette("repweights")`.
