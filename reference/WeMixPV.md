...
#> GROUP.(Intercept) 0.2332214 0.11973218  1.947859 2282.198170 5.155428e-02
#> Residual          0.8132685 0.02299559 35.366280    7.250355 2.186994e-09
#> 
#> Fixed effects:
#>                Estimate Std. Error   t value        df  Pr(>|t|)
#> (Intercept) 0.004824544  0.3417468 0.0141173 181384501 0.9887364
#> --------------------------------------------------------------------------------
#> Estimated models:
#> Math1 ~ 1 + (1 | GROUP)
#> Math2 ~ 1 + (1 | GROUP)
...
#> Random effects:
#>                       Estimate   Std. Error    t value         df     Pr(>|t|)
#> GROUP.(Intercept) 1.666843e-05 8.968191e-05  0.1858616 413.555578 8.526444e-01
#> Residual          5.591163e-01 3.337543e-02 16.7523312   5.787741 3.995963e-06
#> 
#> Fixed effects:
#>                Estimate Std. Error    t value       df     Pr(>|t|)
#> (Intercept) -64.9984631 3.52733989 -18.427048 4.705471 1.440966e-05
